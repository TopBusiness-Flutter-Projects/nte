        ...
        child:Row(
          children: [
            Expanded(
              flex: 2,
                child: Container(
                  decoration: BoxDecoration( borderRadius:  BorderRadius.all(Radius.circular(getSize(context)/22)),),
                  ...
                  child: Padding(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: widget.index%2==0?AppColors.primary:AppColors.redColor,
                        borderRadius: BorderRadius.only(topRight: Radius.circular(getSize(context)/22),
                        topLeft: Radius.circular(getSize(context)/22),)
                      ),
                        child: Center(
                          child: Text(
                            widget.index%2==0?"wait_payment".tr():"pending".tr(),
                            style: TextStyle(
                              color: AppColors.white,
                              fontSize: getSize(context) / 24,
                              fontWeight: FontWeight.w400,
